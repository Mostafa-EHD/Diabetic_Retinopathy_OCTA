...
### 设置参数
images_file = '../C. Diabetic Retinopathy Grading/1. Original Images/a. Training Set'  # 训练图像路径
...
trainval_patient,trainval_label,test_patient,test_label = data_split_crossval(label_file = '../task3_data_fold.xls',fold= 1 ,aff_info = True)
...
model = timm.create_model('efficientnet_b2', pretrained=True, num_classes=3, in_chans=1)
