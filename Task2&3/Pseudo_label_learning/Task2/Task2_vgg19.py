...
### 设置参数
images_file = '../TASK2_IMAGE'  # 训练图像路径
...
trainval_patient,trainval_label,test_patient,test_label = data_split_crossval(label_file = '../task2_data_fold.xls',fold= 0 ,aff_info = True)

dataframe_test = pd.read_csv('Task2_pseudo_label.csv')
...
model_path =  '../task2_vgg19_fold2_random/weights/bestmodel.pth'
